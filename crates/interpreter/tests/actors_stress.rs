    ...
    for i in 0..200 {
        ...
        interp
            .interpret(vec![Stmt::Expression(Expr::Call {
                ...
                arguments: vec![
                    Expr::Literal(core::ast::ArtValue::Int(aid as i64)),
                    Expr::Literal(core::ast::ArtValue::Int(i as i64)),
                    Expr::Literal(core::ast::ArtValue::Int(pri)),
                ],
            })])
            .unwrap();
    }
    ...
    interp
        .interpret(vec![Stmt::Expression(Expr::Call {
            ...
            arguments: vec![
                ...
                Expr::Literal(core::ast::ArtValue::Int(3)),
            ],
        })])
        .unwrap();
    // send 3 messages
