...
#[test]
fn call_zero() {
    let p = unsafe { std::mem::transmute::<extern "C" fn(*mut i64) -> i64, usize>(zero) };
...
#[test]
fn call_one() {
    let p = unsafe { std::mem::transmute::<extern "C" fn(*mut i64, i64) -> i64, usize>(one) };
...
#[test]
fn call_two() {
    let p = unsafe { std::mem::transmute::<extern "C" fn(*mut i64, i64, i64) -> i64, usize>(two) };
